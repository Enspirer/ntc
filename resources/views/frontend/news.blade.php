        ...
        <div class="container mb-5">
            <div class="row">
                <div class="col-7" data-aos="zoom-in-right" data-aos-duration="500">
                    <img src="{{ url('files/news',$news_latest->feature_image) }}" alt="" width="100%" height="350px" style="object-fit:cover;">
                </div>
                <div class="col-5 p-5">
                ...
                @foreach($news as $key => $new)
                    <div class="col-4 p-1 p-0">
                        <div class="card" data-aos="flip-right" data-aos-duration="500" style="min-height: 410px; max-height: 410px;">
                            <img src="{{ url('files/news',$new->feature_image) }}" style="height:220px; object-fit:cover" class="card-img-top" alt="...">
                            <div class="card-body">
