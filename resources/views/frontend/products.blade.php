                                  ...
                                  <div class="card" style="min-height: 390px; max-height: 390px;">
                                      ...
                                      <div class="card-body">
                                        ...
                                        <div class="row align-items-center justify-content-between">
                                          <div class="col">
                                            <a href="{{ route('frontend.solo_product',$product->id) }}" class="text-decoration-none" style="color: #68AE42;">Learn more</a>
                                          </div>
                                          <div class="col">
                                            <a href="" class="btn d-block text-white fw-bold" data-bs-toggle="modal" data-bs-target="#inquire{{$product->id}}" style="background-color: #68AE42;">Inquire Now</a>
